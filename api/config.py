...
MODULE_TIMEOUTS = {
    ...
    "sherlock":       120,  # Internal Sherlock-style social platform checks
...
SHERLOCK_VALIDATION_V2: bool = _env_bool("SHERLOCK_VALIDATION_V2", False)
MAIGRET_ENABLED: bool = _env_bool("MAIGRET_ENABLED", True)
MAIGRET_TOP_N: int = int(os.getenv("MAIGRET_TOP_N", "500"))
